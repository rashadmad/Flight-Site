...
// C:\Users\rashad\AppData\Local\Fusetools\Fuse\App\app-0.27.1.7935\Packages\Fuse.Motion\0.38.6\$.uno
// --------------------------------------------------------------------------------------------------
...
static void DestinationMotion_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\rashad\\AppData\\Local\\Fusetools\\Fuse\\App\\app-0.27.1.7935\\Packages\\Fuse.Motion\\0.38.6\\$.uno");
...
uObject* DestinationMotion::Create()
{
    ...
    switch (Type())
    {
        ...
        default:
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition1(::STRINGS[0/*"Invalidate ...*/], uBox<int>(::g::Fuse::Motion::MotionDestinationType_typeof(), Type())), this, ::STRINGS[1/*"C:\\Users\\...*/], 397, ::STRINGS[2/*"Create"*/]);
