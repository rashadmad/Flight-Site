...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/apps/flight_site/flight_site");
    jclass entryPointsClass = env->FindClass("com/apps/flight_site/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/apps/flight_site/Display");
