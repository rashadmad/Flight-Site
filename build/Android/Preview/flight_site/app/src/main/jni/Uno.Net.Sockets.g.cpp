...
// C:\Users\rashad\AppData\Local\Fusetools\Fuse\App\app-0.27.1.7935\Packages\Uno.Net.Sockets\0.38.2\$.uno
// ------------------------------------------------------------------------------------------------------

// public enum AddressFamily :424
...
// public override sealed bool get_CanSeek() :383
...
// public override sealed bool get_CanWrite() :378
...
// public NetworkStream New(Uno.Net.Sockets.Socket socket) :353
...
// public override sealed long Seek(long byteOffset, Uno.IO.SeekOrigin origin) :399
...
// public override sealed void SetLength(long value) :369
...
// public NetworkStream(Uno.Net.Sockets.Socket socket) [instance] :353
...
// public NetworkStream New(Uno.Net.Sockets.Socket socket) [static] :353
...
// public Socket(Uno.Net.Sockets.AddressFamily addressFamily, Uno.Net.Sockets.SocketType socketType, Uno.Net.Sockets.ProtocolType protocolType) :689
...
// public void Listen(int backlog) :877
void Socket__Listen_fn(Socket* __this, int* backlog)
{
    __this->Listen(*backlog);
}

// public Socket New(Uno.Net.Sockets.AddressFamily addressFamily, Uno.Net.Sockets.SocketType socketType, Uno.Net.Sockets.ProtocolType protocolType) :689
...
// private extern Socket New(Uno.Net.Sockets.Socket.SocketHandle handle, bool connected) :709
void Socket__New2_fn(int* handle, bool* connected, Socket** __retval)
{
    *__retval = Socket::New2(*handle, *connected);
}

// public bool Poll(int milliseconds, Uno.Net.Sockets.SelectMode mode) :888
...
// public void Shutdown(Uno.Net.Sockets.SocketShutdown how) :901
void Socket__Shutdown_fn(Socket* __this, int* how)
{
    __this->Shutdown(*how);
}

// private void UpdateRemoteEndPoint() :742
void Socket__UpdateRemoteEndPoint_fn(Socket* __this)
{
    __this->UpdateRemoteEndPoint();
}

// public Socket(Uno.Net.Sockets.AddressFamily addressFamily, Uno.Net.Sockets.SocketType socketType, Uno.Net.Sockets.ProtocolType protocolType) [instance] :689
...
// private extern Socket(Uno.Net.Sockets.Socket.SocketHandle handle, bool connected) [instance] :709
...
// public Uno.Net.Sockets.Socket Accept() [instance] :917
...
// public void Bind(Uno.Net.EndPoint endPoint) [instance] :850
...
// public void Close() [instance] :930
void Socket::Close()
{
...
// public void Connect(Uno.Net.EndPoint endPoint) [instance] :771
...
// public void Listen(int backlog) [instance] :877
...
// public bool Poll(int milliseconds, Uno.Net.Sockets.SelectMode mode) [instance] :888
...
// public void Shutdown(Uno.Net.Sockets.SocketShutdown how) [instance] :901
...
// private void UpdateRemoteEndPoint() [instance] :742
...
// public Socket New(Uno.Net.Sockets.AddressFamily addressFamily, Uno.Net.Sockets.SocketType socketType, Uno.Net.Sockets.ProtocolType protocolType) [static] :689
...
// private extern Socket New(Uno.Net.Sockets.Socket.SocketHandle handle, bool connected) [static] :709
...
// internal sealed extern class SocketHelpers :471
// {
...
// public static Uno.Net.Sockets.Socket.SocketHandle Accept(Uno.Net.Sockets.Socket.SocketHandle sock) :629
void SocketHelpers__Accept_fn(int* sock, int* __retval)
{
    *__retval = SocketHelpers::Accept(*sock);
}

// public static int Bind(Uno.Net.Sockets.Socket.SocketHandle sock, int family, byte[] address, long scopeId, int port) :584
...
// public static int Connect(Uno.Net.Sockets.Socket.SocketHandle sock, int family, byte[] address, long scopeId, int port) :558
...
// public static int GetFamily(Uno.Net.Sockets.AddressFamily addressFamily) :473
void SocketHelpers__GetFamily_fn(int* addressFamily, int* __retval)
{
    *__retval = SocketHelpers::GetFamily(*addressFamily);
}

// public static Uno.Net.IPEndPoint GetLocalEndPoint(Uno.Net.Sockets.Socket.SocketHandle sock) :512
...
// public static int GetProtocol(Uno.Net.Sockets.ProtocolType protocolType) :492
void SocketHelpers__GetProtocol_fn(int* protocolType, int* __retval)
{
    *__retval = SocketHelpers::GetProtocol(*protocolType);
}

// public static Uno.Net.IPEndPoint GetRemoteEndPoint(Uno.Net.Sockets.Socket.SocketHandle sock) :537
...
// public static int GetSocketShudown(Uno.Net.Sockets.SocketShutdown socketShutdown) :501
...
// public static int GetType(Uno.Net.Sockets.SocketType socketType) :483
void SocketHelpers__GetType1_fn(int* socketType, int* __retval)
{
    *__retval = SocketHelpers::GetType1(*socketType);
}

// public static int Poll(Uno.Net.Sockets.Socket.SocketHandle sock, int milliseconds, Uno.Net.Sockets.SelectMode mode) :610
...
// public static extern int Shutdown(Uno.Net.Sockets.Socket.SocketHandle sock, int how) :657
void SocketHelpers__Shutdown_fn(int* sock, int* how, int* __retval)
{
    *__retval = SocketHelpers::Shutdown(*sock, *how);
}

// public static Uno.Net.Sockets.Socket.SocketHandle Accept(Uno.Net.Sockets.Socket.SocketHandle sock) [static] :629
...
// public static int Bind(Uno.Net.Sockets.Socket.SocketHandle sock, int family, byte[] address, long scopeId, int port) [static] :584
...
// public static int Connect(Uno.Net.Sockets.Socket.SocketHandle sock, int family, byte[] address, long scopeId, int port) [static] :558
...
// public static int GetFamily(Uno.Net.Sockets.AddressFamily addressFamily) [static] :473
...
// public static Uno.Net.IPEndPoint GetLocalEndPoint(Uno.Net.Sockets.Socket.SocketHandle sock) [static] :512
...
// public static int GetProtocol(Uno.Net.Sockets.ProtocolType protocolType) [static] :492
...
// public static Uno.Net.IPEndPoint GetRemoteEndPoint(Uno.Net.Sockets.Socket.SocketHandle sock) [static] :537
...
// public static int GetSocketShudown(Uno.Net.Sockets.SocketShutdown socketShutdown) [static] :501
...
// public static int GetType(Uno.Net.Sockets.SocketType socketType) [static] :483
...
// public static int Poll(Uno.Net.Sockets.Socket.SocketHandle sock, int milliseconds, Uno.Net.Sockets.SelectMode mode) [static] :610
...
// public static extern int Shutdown(Uno.Net.Sockets.Socket.SocketHandle sock, int how) [static] :657
...
// public enum SocketShutdown :451
