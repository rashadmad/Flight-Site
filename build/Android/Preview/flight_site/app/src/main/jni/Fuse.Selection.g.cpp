...
// C:\Users\rashad\AppData\Local\Fusetools\Fuse\App\app-0.27.1.7935\Packages\Fuse.Selection\0.38.6\$.uno
// -----------------------------------------------------------------------------------------------------
...
static void Selectable_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("C:\\Users\\rashad\\AppData\\Local\\Fusetools\\Fuse\\App\\app-0.27.1.7935\\Packages\\Fuse.Selection\\0.38.6\\$.uno");
...
void Selectable__OnRooted_fn(Selectable* __this)
{
    ...
    if (__this->_selection == NULL)
        ::g::Fuse::Diagnostics::UserError(::STRINGS[7/*"Unable to l...*/], __this, ::STRINGS[4/*"C:\\Users\\...*/], 97, ::STRINGS[8/*"OnRooted"*/]);
}
...
void Selectable::Add1()
{
    ...
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[5/*"No selectio...*/], this, ::STRINGS[4/*"C:\\Users\\...*/], 135, ::STRINGS[6/*"Add"*/]);
        return;
    }
...
void Selectable::Remove1()
{
    ...
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[5/*"No selectio...*/], this, ::STRINGS[4/*"C:\\Users\\...*/], 149, ::STRINGS[10/*"Remove"*/]);
        return;
    }
...
void Selectable::Toggle()
{
    ...
    if (_selection == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[5/*"No selectio...*/], this, ::STRINGS[4/*"C:\\Users\\...*/], 163, ::STRINGS[12/*"Toggle"*/]);
        return;
    }
...
void Selectable::add(::g::Fuse::Scripting::Context* c, Selectable* s, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[3/*"add require...*/], s, ::STRINGS[4/*"C:\\Users\\...*/], 30, ::STRINGS[0/*"add"*/]);
        return;
    }
...
void Selectable::remove(::g::Fuse::Scripting::Context* c, Selectable* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[9/*"remove requ...*/], s, ::STRINGS[4/*"C:\\Users\\...*/], 48, ::STRINGS[1/*"remove"*/]);
        return;
    }
...
void Selectable::toggle(::g::Fuse::Scripting::Context* c, Selectable* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[11/*"toggle requ...*/], s, ::STRINGS[4/*"C:\\Users\\...*/], 64, ::STRINGS[2/*"toggle"*/]);
        return;
    }
...
static void Selection_build(uType* type)
{
    ...
    ::TYPES[9] = ::g::Fuse::Selection::Selectable_typeof();
    ::TYPES[10] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[11] = ::g::Fuse::Scripting::Observable__Subscription_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
...
// public void ForceAdd(Fuse.Selection.Selectable b) :628
...
// public void ForceRemove(Fuse.Selection.Selectable b) :645
...
void Selection__FuseScriptingIObserverOnAdd_fn(Selection* __this, uObject* addedValue)
{
    ...
    uString* ret11;
    ::g::Uno::Collections::List__Add_fn(uPtr(__this->_values), (::g::Fuse::Scripting::Marshal__ToType_fn(::TYPES[7/*Fuse.Scripting.Marshal.ToType<string>*/], addedValue, &ret11), ret11));
...
// private void Fuse.Scripting.IObserver.OnFailed(string message) :876
void Selection__FuseScriptingIObserverOnFailed_fn(Selection* __this, uString* message)
{
    ...
    ::g::Fuse::Diagnostics::InternalError(message, __this, ::STRINGS[4/*"C:\\Users\\...*/], 878, ::STRINGS[21/*"Fuse.Script...*/]);
}
...
void Selection__FuseScriptingIObserverOnInsertAt_fn(Selection* __this, int* index, uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"removing in...*/], __this, ::STRINGS[4/*"C:\\Users\\...*/], 869, ::STRINGS[23/*"Fuse.Script...*/]);
        return;
    }

    ::g::Uno::Collections::List__Insert_fn(uPtr(__this->_values), uCRef<int>(index_), (::g::Fuse::Scripting::Marshal__ToType_fn(::TYPES[7/*Fuse.Scripting.Marshal.ToType<string>*/], value, &ret12), ret12));
    __this->OnSelectionChanged(1);
}
...
void Selection__FuseScriptingIObserverOnNewAll_fn(Selection* __this, ::g::Fuse::Scripting::ListMirror* values)
{
    ...
    for (int i = 0; i < uPtr(values)->Length(); ++i)
        ::g::Uno::Collections::List__Add_fn(uPtr(__this->_values), (::g::Fuse::Scripting::Marshal__ToType_fn(::TYPES[7/*Fuse.Scripting.Marshal.ToType<string>*/], uPtr(values)->Item(i), &ret13), ret13));
...
void Selection__FuseScriptingIObserverOnNewAt_fn(Selection* __this, int* index, uObject* newValue)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"removing in...*/], __this, ::STRINGS[4/*"C:\\Users\\...*/], 834, ::STRINGS[24/*"Fuse.Script...*/]);
        return;
    }

    ::g::Uno::Collections::List__set_Item_fn(uPtr(__this->_values), uCRef<int>(index_), (::g::Fuse::Scripting::Marshal__ToType_fn(::TYPES[7/*Fuse.Scripting.Marshal.ToType<string>*/], newValue, &ret14), ret14));
    __this->OnSelectionChanged(1);
}
...
void Selection__FuseScriptingIObserverOnRemoveAt_fn(Selection* __this, int* index)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"removing in...*/], __this, ::STRINGS[4/*"C:\\Users\\...*/], 858, ::STRINGS[25/*"Fuse.Script...*/]);
        return;
    }
...
void Selection__FuseScriptingIObserverOnSet_fn(Selection* __this, uObject* newValue)
{
    ...
    uString* ret15;
    uPtr(__this->_values)->Clear();
    ::g::Uno::Collections::List__Add_fn(uPtr(__this->_values), (::g::Fuse::Scripting::Marshal__ToType_fn(::TYPES[7/*Fuse.Scripting.Marshal.ToType<string>*/], newValue, &ret15), ret15));
    __this->OnSelectionChanged(1);
}
...
// public bool IsSelected(Fuse.Selection.Selectable b) :571
...
// public int get_SelectedCount() :664
...
// public void SetValue(string value, Uno.UX.IPropertyListener origin) :685
...
// public void ForceAdd(Fuse.Selection.Selectable b) [instance] :628
...
// public void ForceRemove(Fuse.Selection.Selectable b) [instance] :645
...
// public bool IsSelected(Fuse.Selection.Selectable b) [instance] :571
bool Selection::IsSelected(::g::Fuse::Selection::Selectable* b)
{
    ...
    bool ret16;
    return (::g::Uno::Collections::List__Contains_fn(uPtr(_values), uPtr(b)->Value(), &ret16), ret16);
}
...
void Selection::MaxCount(int value)
{
    ...
    if (value < 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[28/*"MaxCount mu...*/], this, ::STRINGS[4/*"C:\\Users\\...*/], 549, ::STRINGS[29/*"set_MaxCount"*/]);
        return;
    }
...
void Selection::OnSelectionChanged(int how)
{
    ...
    if ((how == 0) && (_subscription != NULL))
        uPtr(_subscription)->ReplaceAllExclusive(::TYPES[11/*Fuse.Scripting.Observable.Subscription.ReplaceAllExclusive<string>*/], (uArray*)uPtr(_values)->ToArray());
}
...
// public int get_SelectedCount() [instance] :664
...
// public void SetValue(string value, Uno.UX.IPropertyListener origin) [instance] :685
void Selection::SetValue(uString* value, uObject* origin)
{
    ...
    for (int i = uPtr(_values)->Count() - 1; i >= 0; i--)
        if (::g::Uno::String::op_Inequality((::g::Uno::Collections::List__get_Item_fn(uPtr(_values), uCRef<int>(i), &ret22), ret22), value))
            Remove2((::g::Uno::Collections::List__get_Item_fn(uPtr(_values), uCRef<int>(i), &ret23), ret23));
        else
            has = true;
...
// public string get_Value() [instance] :679
uString* Selection::Value()
{
    uStackFrame __("Fuse.Selection.Selection", "get_Value()");
    uString* ret27;
    return (uPtr(_values)->Count() > 0) ? (::g::Uno::Collections::List__get_Item_fn(uPtr(_values), uCRef<int>(0), &ret27), ret27) : ::STRINGS[30/*""*/];
}

// public void set_Value(string value) [instance] :683
...
// public object get_Values() [instance] :779
...
// public void set_Values(object value) [instance] :780
void Selection::Values(uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[31/*"`Values` mu...*/], this, ::STRINGS[4/*"C:\\Users\\...*/], 785, ::STRINGS[32/*"set_Values"*/]);
        return;
    }
...
void Selection::add(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[17/*"add require...*/], s, ::STRINGS[4/*"C:\\Users\\...*/], 320, ::STRINGS[0/*"add"*/]);
        return;
    }
...
void Selection::clear(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[18/*"clear requi...*/], s, ::STRINGS[4/*"C:\\Users\\...*/], 302, ::STRINGS[14/*"clear"*/]);
        return;
    }
...
{
    uStackFrame __("Fuse.Selection.Selection", "FindLocalSelectable(Fuse.Visual)");
    Selection_typeof()->Init();
    ::g::Fuse::Node* ret4;

    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(v)->Children()), ::TYPES[8/*Uno.Collections.ICollection<Fuse.Node>*/])); ++i)
    {
        ::g::Fuse::Selection::Selectable* l = uAs< ::g::Fuse::Selection::Selectable*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(v)->Children()), ::TYPES[10/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret4), ret4), ::TYPES[9/*Fuse.Selection.Selectable*/]);
...
{
    uStackFrame __("Fuse.Selection.Selection", "FindLocalSelection(Fuse.Visual)");
    Selection_typeof()->Init();
    ::g::Fuse::Node* ret5;

    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(v)->Children()), ::TYPES[8/*Uno.Collections.ICollection<Fuse.Node>*/])); ++i)
    {
        Selection* l = uAs<Selection*>((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(v)->Children()), ::TYPES[10/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(i), &ret5), ret5), Selection_typeof());
...
void Selection::forceAdd(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[19/*"forceAdd re...*/], s, ::STRINGS[4/*"C:\\Users\\...*/], 352, ::STRINGS[15/*"forceAdd"*/]);
        return;
    }

    uPtr(s)->ForceAdd1((::g::Fuse::Scripting::Marshal__ToType_fn(::TYPES[7/*Fuse.Scripting.Marshal.ToType<string>*/], uPtr(args)->Strong<uObject*>(0), &ret6), ret6));
}
...
void Selection::forceRemove(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[20/*"forceRemove...*/], s, ::STRINGS[4/*"C:\\Users\\...*/], 366, ::STRINGS[16/*"forceRemove"*/]);
        return;
    }

    uPtr(s)->ForceRemove1((::g::Fuse::Scripting::Marshal__ToType_fn(::TYPES[7/*Fuse.Scripting.Marshal.ToType<string>*/], uPtr(args)->Strong<uObject*>(0), &ret8), ret8));
}
...
void Selection::remove(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[26/*"remove requ...*/], s, ::STRINGS[4/*"C:\\Users\\...*/], 338, ::STRINGS[1/*"remove"*/]);
        return;
    }

    uPtr(s)->Remove2((::g::Fuse::Scripting::Marshal__ToType_fn(::TYPES[7/*Fuse.Scripting.Marshal.ToType<string>*/], uPtr(args)->Strong<uObject*>(0), &ret19), ret19));
}
...
void Selection::toggle(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[27/*"toggle requ...*/], s, ::STRINGS[4/*"C:\\Users\\...*/], 382, ::STRINGS[2/*"toggle"*/]);
        return;
    }

    uPtr(s)->Toggle1((::g::Fuse::Scripting::Marshal__ToType_fn(::TYPES[7/*Fuse.Scripting.Marshal.ToType<string>*/], uPtr(args)->Strong<uObject*>(0), &ret25), ret25));
}
...
void SelectionEvent__OnRooted_fn(SelectionEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Unable to l...*/], __this, ::STRINGS[4/*"C:\\Users\\...*/], 215, ::STRINGS[8/*"OnRooted"*/]);
        return;
    }
...
// public generated ToggleSelection() :922
...
// public generated ToggleSelection New() :922
...
void ToggleSelection__Perform_fn(ToggleSelection* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[35/*"Unable to l...*/], __this, ::STRINGS[4/*"C:\\Users\\...*/], 942, ::STRINGS[36/*"Perform"*/]);
        return;
    }
...
// public generated ToggleSelection() [instance] :922
...
// public generated ToggleSelection New() [static] :922
...
// public sealed class WhileSelected :979
// {
...
// public generated WhileSelected() :979
void WhileSelected__ctor_5_fn(WhileSelected* __this)
{
    __this->ctor_5();
}

// public generated WhileSelected New() :979
...
void WhileSelected__OnRooted_fn(WhileSelected* __this)
{
    ...
    if (!::g::Fuse::Selection::Selection::TryFindSelectable(__this->Parent(), &__this->_selectable, &__this->_selection))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Unable to l...*/], __this, ::STRINGS[4/*"C:\\Users\\...*/], 990, ::STRINGS[8/*"OnRooted"*/]);
        return;
    }
...
// private void OnSelectionChanged(object s, object args) :1008
void WhileSelected__OnSelectionChanged_fn(WhileSelected* __this, uObject* s, uObject* args)
{
    __this->OnSelectionChanged(s, args);
}

// protected override sealed void OnUnrooted() :998
...
// public generated WhileSelected() [instance] :979
...
// private void OnSelectionChanged(object s, object args) [instance] :1008
...
// public generated WhileSelected New() [static] :979
