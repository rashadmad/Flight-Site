...
// C:\Users\rashad\AppData\Local\Fusetools\Fuse\App\app-0.27.1.7935\Packages\Fuse.Controls.Primitives\0.38.6\$.uno
// ---------------------------------------------------------------------------------------------------------------

// internal sealed class ShadowElement :754
// {
static void ShadowElement_build(uType* type)
{
    ...
    type->SetFields(87,
        ...
        ::g::Fuse::Controls::Panel_typeof(), offsetof(::g::Fuse::Controls::Primitives::ShadowElement, _panelParent), 0,
...
// public generated ShadowElement() :754
void ShadowElement__ctor_4_fn(ShadowElement* __this)
{
    __this->ctor_4();
}

// protected override sealed Fuse.VisualBounds CalcRenderBounds() :859
...
void ShadowElement__OnDraw_fn(ShadowElement* __this, ::g::Fuse::DrawContext* dc)
{
    ...
    if (__this->_rectangleParent != NULL)
        alphaFade = alphaFade * uPtr(__this->_rectangleParent)->Color().W;

    if (__this->_panelParent != NULL)
        alphaFade = alphaFade * uPtr(__this->_panelParent)->Color().W;
    ...
    uPtr(::g::Fuse::Drawing::Primitives::Rectangle::Singleton())->Shadow(dc, __this, __this->ActualSize(), __this->CornerRadius(), __this->_fill, ::g::Uno::Float2__New1(0.0f), __this->Smoothness());
}

// protected override sealed void OnRooted() :760
void ShadowElement__OnRooted_fn(ShadowElement* __this)
{
    ...
    __this->_rectangleParent = uAs< ::g::Fuse::Controls::Rectangle*>(__this->Parent(), ::TYPES[0/*Fuse.Controls.Rectangle*/]);

    if (__this->_rectangleParent != NULL)
        uPtr(__this->_rectangleParent)->AddPropertyListener((uObject*)__this);

    __this->_panelParent = uAs< ::g::Fuse::Controls::Panel*>(__this->Parent(), ::TYPES[1/*Fuse.Controls.Panel*/]);

    if (__this->_panelParent != NULL)
        uPtr(__this->_panelParent)->AddPropertyListener((uObject*)__this);

    __this->_minSmoothness = (1.5f / ::g::Fuse::ICommonViewport::PixelsPerPoint(uInterface(uPtr(__this->Viewport()), ::TYPES[2/*Fuse.ICommonViewport*/])));
}

// protected override sealed void OnUnrooted() :775
...
void ShadowElement__UnoUXIPropertyListenerOnPropertyChanged_fn(ShadowElement* __this, ::g::Uno::UX::PropertyObject* obj, ::g::Uno::UX::Selector* prop)
{
    ...
    if (__this->_rectangleParent != NULL)
    {
        if (::g::Uno::UX::Selector__op_Equality(prop_, ::g::Fuse::Controls::Rectangle::CornerRadiusPropertyName()) || ::g::Uno::UX::Selector__op_Equality(prop_, ::g::Fuse::Controls::Shape::ColorPropertyName()))
            __this->InvalidateVisual();
    }

    if (__this->_panelParent != NULL)
    {
        if (::g::Uno::UX::Selector__op_Equality(prop_, ::g::Fuse::Controls::Panel::ColorPropertyName()))
            __this->InvalidateVisual();
    }
}

// public generated ShadowElement() [instance] :754
...
// public float4 get_Color() [instance] :848
...
// public void set_Color(float4 value) [instance] :849
...
// private float4 get_CornerRadius() [instance] :823
...
// private float get_MaxSize() [instance] :834
...
// public float get_Size() [instance] :809
...
// public void set_Size(float value) [instance] :810
...
// private float get_Smoothness() [instance] :838
...
// public generated ShadowElement New() [static] :754
