...
// C:\Users\rashad\AppData\Local\Fusetools\Fuse\App\app-0.27.1.7935\Packages\Fuse.Controls.Video\0.38.6\$.uno
// ----------------------------------------------------------------------------------------------------------
...
static void VideoDiskCache_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("C:\\Users\\rashad\\AppData\\Local\\Fusetools\\Fuse\\App\\app-0.27.1.7935\\Packages\\Fuse.Controls.Video\\0.38.6\\$.uno");
...
void VideoDiskCache::OnWindowClosed(uObject* sender, ::g::Uno::EventArgs* args)
{
    ...
    for (::g::Uno::Collections::Dictionary__Enumerator<uStrong<uString*>, uStrong<uString*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(VideoDiskCache::_files()), &ret4), ret4); enum1.MoveNext(::TYPES[14/*Uno.Collections.Dictionary<string, string>.Enumerator*/]); )
    {
        ...
        {
            ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[2/*"Deleting te...*/], pair.Value(::TYPES[15/*Uno.Collections.KeyValuePair<string, string>*/])), 1, ::STRINGS[3/*"C:\\Users\\...*/], 897);
...
void VideoVisual__FuseControlsVideoImplIVideoCallbacksOnError_fn(VideoVisual* __this, ::g::Uno::Exception* e)
{
    ...
    ::g::Fuse::Diagnostics::UnknownException(::STRINGS[5/*"Video error"*/], e, __this, ::STRINGS[3/*"C:\\Users\\...*/], 1067, ::STRINGS[6/*"Fuse.Contro...*/]);
}
...
// private double Fuse.Triggers.IMediaPlayback.get_Duration() :1103
...
// private float Fuse.Triggers.IMediaPlayback.get_Volume() :1091
...
// private void Fuse.Triggers.IMediaPlayback.set_Volume(float value) :1092
...
void VideoVisual__FuseTriggersIPlaybackPlayTo_fn(VideoVisual* __this, double* progress)
{
    ...
    ::g::Fuse::Diagnostics::Unsupported(::STRINGS[7/*"IPlayback.P...*/], __this, ::STRINGS[3/*"C:\\Users\\...*/], 1114, ::STRINGS[8/*"Fuse.Trigge...*/]);
}
