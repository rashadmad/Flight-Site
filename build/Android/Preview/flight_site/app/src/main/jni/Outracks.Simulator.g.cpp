...
// C:\Users\rashad\AppData\Local\Fusetools\Fuse\App\app-0.27.1.7935\Packages\Outracks.Simulator.Protocol.Uno\0.0.0\$.uno
// ---------------------------------------------------------------------------------------------------------------------
...
// C:\Users\rashad\AppData\Local\Fusetools\Fuse\App\app-0.27.1.7935\Packages\Outracks.Simulator.Client.Uno\0.1.0\$.uno
// -------------------------------------------------------------------------------------------------------------------
...
static void Application_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("C:\\Users\\rashad\\AppData\\Local\\Fusetools\\Fuse\\App\\app-0.27.1.7935\\Packages\\Outracks.Simulator.Client.Uno\\0.1.0\\$.uno");
...
// C:\Users\rashad\AppData\Local\Fusetools\Fuse\App\app-0.27.1.7935\Packages\Outracks.Simulator.Protocol.Uno\0.0.0\common\$.uno
// ----------------------------------------------------------------------------------------------------------------------------
...
// public sealed class ArrayStream :1080
// {
...
// public override sealed bool get_CanSeek() :1099
...
// public override sealed bool get_CanTimeout() :1104
...
// public override sealed bool get_CanWrite() :1094
...
// public ArrayStream New(byte[] buffer) :1125
void ArrayStream__New1_fn(uArray* buffer, ArrayStream** __retval)
{
    *__retval = ArrayStream::New1(buffer);
}

// public generated override sealed long get_Position() :1123
...
// public generated override sealed void set_Position(long value) :1123
...
// public override sealed int Read(byte[] dst, int byteOffset, int byteCount) :1145
...
// private void ResizeTo(int newSize) :1189
void ArrayStream__ResizeTo_fn(ArrayStream* __this, int* newSize)
{
    __this->ResizeTo(*newSize);
}

// public override sealed long Seek(long byteOffset, Uno.IO.SeekOrigin origin) :1156
...
// public override sealed void SetLength(long value) :1202
...
// public override sealed void Write(byte[] src, int byteOffset, int byteCount) :1131
...
// public ArrayStream(byte[] buffer) [instance] :1125
...
// public int get_Capacity() [instance] :1117
...
// private void EnsureCapacity(int byteCount) [instance] :1173
...
// public byte[] GetBuffer() [instance] :1197
...
// private void ResizeTo(int newSize) [instance] :1189
...
// public ArrayStream New(byte[] buffer) [static] :1125
...
// public static extern void AddOrUpdateFile(string projectRelativeFilePath, byte[] data) :2184
...
// public static extern void AddOrUpdateFile(string projectRelativeFilePath, byte[] data) [static] :2184
...
// internal sealed class ChangeIp :693
// {
...
// public override sealed Outracks.Simulator.State OnException(Uno.Exception e) :714
...
// protected override sealed Outracks.Simulator.State OnOk(string input) :700
...
// public ChangeIp([string body]) [instance] :695
...
// public ChangeIp New([string body]) [static] :695
...
// private sealed class EnumerableHitTestExtension.CollectHitNodesClosure :2070
// {
...
// public CollectHitNodesClosure(Uno.Collections.List<Fuse.Visual> nodes) :2074
...
// public void HitTestCallback(Fuse.HitTestResult result) :2079
...
// public CollectHitNodesClosure New(Uno.Collections.List<Fuse.Visual> nodes) :2074
...
// public CollectHitNodesClosure(Uno.Collections.List<Fuse.Visual> nodes) [instance] :2074
...
// public void HitTestCallback(Fuse.HitTestResult result) [instance] :2079
...
// public CollectHitNodesClosure New(Uno.Collections.List<Fuse.Visual> nodes) [static] :2074
...
// C:\Users\rashad\AppData\Local\Fusetools\Fuse\App\app-0.27.1.7935\Packages\Outracks.Simulator.Protocol.Uno\0.0.0\concurrency\$.uno
// ---------------------------------------------------------------------------------------------------------------------------------
...
// internal sealed class ConnectionLost :663
// {
...
// public ConnectionLost(Outracks.Simulator.Protocol.ExceptionInfo exception) :669
...
// public ConnectionLost(Uno.Exception exception) :665
void ConnectionLost__ctor_3_fn(ConnectionLost* __this, ::g::Uno::Exception* exception)
{
    __this->ctor_3(exception);
}

// public ConnectionLost New(Outracks.Simulator.Protocol.ExceptionInfo exception) :669
...
// public ConnectionLost New(Uno.Exception exception) :665
void ConnectionLost__New3_fn(::g::Uno::Exception* exception, ConnectionLost** __retval)
{
    *__retval = ConnectionLost::New3(exception);
}

// public ConnectionLost(Outracks.Simulator.Protocol.ExceptionInfo exception) [instance] :669
...
// public ConnectionLost(Uno.Exception exception) [instance] :665
...
// public ConnectionLost New(Outracks.Simulator.Protocol.ExceptionInfo exception) [static] :669
...
// public ConnectionLost New(Uno.Exception exception) [static] :665
...
// internal sealed class ConnectToEndpointClosure :921
// {
...
// public ConnectToEndpointClosure(Uno.Net.IPEndPoint endpoint) :925
...
// public Uno.Net.Sockets.Socket Execute() :930
...
// public ConnectToEndpointClosure New(Uno.Net.IPEndPoint endpoint) :925
...
// public ConnectToEndpointClosure(Uno.Net.IPEndPoint endpoint) [instance] :925
...
// public Uno.Net.Sockets.Socket Execute() [instance] :930
...
// public ConnectToEndpointClosure New(Uno.Net.IPEndPoint endpoint) [static] :925
...
// public static class ConnectToFirstRespondingEndpoint :904
// {
...
// public static Outracks.Simulator.Task<Uno.Net.Sockets.Socket> Execute(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) :906
...
// private static Uno.Net.Sockets.Socket OnNoResult(Uno.Collections.IEnumerable<Uno.Exception> exceptions) :915
...
// public static Outracks.Simulator.Task<Uno.Net.Sockets.Socket> Execute(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) [static] :906
...
// private static Uno.Net.Sockets.Socket OnNoResult(Uno.Collections.IEnumerable<Uno.Exception> exceptions) [static] :915
...
// public partial sealed class DeveloperMenu :2234
// {
...
// private void Close(object sender, Uno.EventArgs args) :2241
void DeveloperMenu__Close_fn(DeveloperMenu* __this, uObject* sender, ::g::Uno::EventArgs* args)
{
    __this->Close(sender, args);
}

// private void GoBack(object sender, Uno.EventArgs args) :2236
...
// private void Close(object sender, Uno.EventArgs args) [instance] :2241
...
// private void GoBack(object sender, Uno.EventArgs args) [instance] :2236
...
uString* DeviceInfo::GetGUID()
{
    uStackFrame __("Outracks.Simulator.DeviceInfo", "GetGUID()");
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetGUID275", "()Ljava/lang/String;");
...
uString* DeviceInfo::GetName()
{
    uStackFrame __("Outracks.Simulator.DeviceInfo", "GetName()");
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetName276", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
...
// internal sealed class DiagnosticItem :2263
// {
...
// public generated DiagnosticItem New() [static] :2263
...
// internal sealed class DiagnosticShower :2282
// {
...
// public DiagnosticShower(Fuse.Diagnostic diagnosticItem, Uno.Collections.List<Outracks.Simulator.DiagnosticItem> previousDiagnosticItems) :2287
...
// private void DisplayDiagnostic(Fuse.Diagnostic d) :2323
void DiagnosticShower__DisplayDiagnostic_fn(DiagnosticShower* __this, ::g::Fuse::Diagnostic* d)
{
    __this->DisplayDiagnostic(d);
}

// public DiagnosticShower New(Fuse.Diagnostic diagnosticItem, Uno.Collections.List<Outracks.Simulator.DiagnosticItem> previousDiagnosticItems) :2287
...
// public void Show() :2293
void DiagnosticShower__Show_fn(DiagnosticShower* __this)
{
    __this->Show();
}

// public DiagnosticShower(Fuse.Diagnostic diagnosticItem, Uno.Collections.List<Outracks.Simulator.DiagnosticItem> previousDiagnosticItems) [instance] :2287
...
// private void DisplayDiagnostic(Fuse.Diagnostic d) [instance] :2323
...
// public void Show() [instance] :2293
...
// public DiagnosticShower New(Fuse.Diagnostic diagnosticItem, Uno.Collections.List<Outracks.Simulator.DiagnosticItem> previousDiagnosticItems) [static] :2287
...
// public static Uno.Collections.IList<Fuse.Visual> HitTest2(Fuse.Visual node, float2 windowPoint) :2062
...
// public static Uno.Collections.IList<Fuse.Visual> HitTest2(Fuse.Visual node, float2 windowPoint) [static] :2062
...
// public partial sealed class ErrorToast :2210
// {
...
static void ErrorToast_build(uType* type)
{
    ...
    ::TYPES[57] = ::g::Fuse::Controls::PropertyBinding_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[58] = ::g::Fuse::Controls::PropertyBinding_typeof()->MakeType(::g::Uno::Bool_typeof());
    ::TYPES[52] = ::g::Fuse::Animations::Change_typeof()->MakeType(::g::Uno::Float_typeof());
    ::TYPES[59] = ::g::Fuse::Controls::PropertyBinding_typeof()->MakeType(::g::Uno::Float4_typeof());
    ::TYPES[11] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[60] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof());
    ::TYPES[53] = ::g::Fuse::Gestures::ClickedHandler_typeof();
    ::TYPES[54] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof());
    ::TYPES[61] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Drawing::Stroke_typeof());
    ::TYPES[9] = ::g::Uno::Action_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Controls::Control_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Controls::Control_type, interface1),
...
// public generated void add_Dismissed(Uno.Action value) :2224
void ErrorToast__add_Dismissed_fn(ErrorToast* __this, uDelegate* value)
{
    __this->add_Dismissed(value);
}

// public generated void remove_Dismissed(Uno.Action value) :2224
...
// public generated void add_Dismissed(Uno.Action value) [instance] :2224
...
// public generated void remove_Dismissed(Uno.Action value) [instance] :2224
...
void ErrorToast::InitializeUX1()
{
    ...
    ::g::Fuse::Controls::PropertyBinding* temp5 = (::g::Fuse::Controls::PropertyBinding*)::g::Fuse::Controls::PropertyBinding::New1(::TYPES[57/*Fuse.Controls.PropertyBinding<string>*/], temp_Value_inst, this_Message_inst);
    ::g::Fuse::Controls::Text* temp6 = ::g::Fuse::Controls::Text::New3();
    ::g::Fuse::Controls::Button* temp7 = ::g::Fuse::Controls::Button::New5();
    ::g::Fuse::Controls::PropertyBinding* temp8 = (::g::Fuse::Controls::PropertyBinding*)::g::Fuse::Controls::PropertyBinding::New1(::TYPES[58/*Fuse.Controls.PropertyBinding<bool>*/], temp1_Value_inst, this_ShowMonitorInfo_inst);
    ...
    ::g::Fuse::Controls::PropertyBinding* temp15 = (::g::Fuse::Controls::PropertyBinding*)::g::Fuse::Controls::PropertyBinding::New1(::TYPES[59/*Fuse.Controls.PropertyBinding<float4>*/], temp2_Color_inst, this_FillColor_inst);
    ::g::Fuse::Controls::PropertyBinding* temp16 = (::g::Fuse::Controls::PropertyBinding*)::g::Fuse::Controls::PropertyBinding::New1(::TYPES[59/*Fuse.Controls.PropertyBinding<float4>*/], temp3_Color_inst, this_StrokeColor_inst);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Bindings()), ::TYPES[60/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp5);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Bindings()), ::TYPES[60/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp8);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp2->Bindings()), ::TYPES[60/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp15);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp2->Bindings()), ::TYPES[60/*Uno.Collections.ICollection<Fuse.Binding>*/]), temp16);
    temp3->Width(2.0f);
...
// private void OnClicked(object sender, Uno.EventArgs args) [instance] :2212
...
{
    ::TYPES[36] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    ::TYPES[62] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Exception_typeof());
...
// internal sealed class FailedToConnect :680
// {
...
// public FailedToConnect New(Uno.Exception exception) [static] :682
...
static void FailedToConnectToProxy_build(uType* type)
{
    ::STRINGS[45] = uString::Const("Failed to connect to proxy:\n"
        "");
    ::TYPES[64] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Uno::Exception_typeof());
    type->SetFields(3,
...
void FailedToConnectToProxy::ctor_3(uObject* innerExceptions)
{
    ...
    InnerExceptions = ((::g::Outracks::Simulator::ImmutableList*)::g::Outracks::Simulator::List::ToImmutableList(::TYPES[64/*Outracks.Simulator.List.ToImmutableList<Uno.Exception>*/], innerExceptions));
}
...
// public FailedToConnectToSimulator(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) :896
void FailedToConnectToSimulator__ctor_3_fn(FailedToConnectToSimulator* __this, uObject* innerExceptions)
{
    __this->ctor_3(innerExceptions);
}

// public FailedToConnectToSimulator New(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) :896
...
// public FailedToConnectToSimulator(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) [instance] :896
...
// public FailedToConnectToSimulator New(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) [static] :896
...
{
    ::TYPES[65] = ::g::Outracks::Simulator::ConcurrentQueue_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[11] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[9] = ::g::Uno::Action_typeof();
    ::TYPES[66] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Node_typeof());
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Controls::Control_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Controls::Control_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Controls::Control_type, interface2),
...
// protected override sealed void OnDraw(Fuse.DrawContext dc) :1956
...
void FakeApp::ctor_7(::g::Fuse::App* app)
{
    ...
    _flashes = ((::g::Outracks::Simulator::ConcurrentQueue*)::g::Outracks::Simulator::ConcurrentQueue::New1(::TYPES[65/*Outracks.Simulator.ConcurrentQueue<string>*/]));
    ctor_6();
    _app = app;
...
// public float get_ClearDepth() [instance] :1948
...
// public void set_ClearDepth(float value) [instance] :1949
...
::g::Fuse::Node* FakeApp::Overlay()
{
    ...
    ::g::Fuse::Node* ret3;
    return (::g::Uno::Collections::EnumerableExtensions__FirstOrDefault_fn(::TYPES[66/*Uno.Collections.EnumerableExtensions.FirstOrDefault<Fuse.Node>*/], uPtr(_overlayPlaceholde)->Children(), &ret3), ret3);
}
...
// internal sealed class Faulted :652
// {
...
// public Faulted(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) :654
...
// public Faulted New(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) :654
...
// public Faulted(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) [instance] :654
...
// public Faulted New(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) [static] :654
...
// internal sealed class Flasher :1985
// {
static void Flasher_build(uType* type)
{
    ::STRINGS[49] = uString::Const("#222");
    ::TYPES[67] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Drawing::GradientStop_typeof());
    ::TYPES[11] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[9] = ::g::Uno::Action_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Controls::Control_type, interface0),
...
// protected override sealed void OnUnrooted() :2015
...
// private void OnUpdate() :2021
void Flasher__OnUpdate_fn(Flasher* __this)
{
    __this->OnUpdate();
}

// public Flasher(string text) [instance] :1989
void Flasher::ctor_7(uString* text)
{
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(linearGradient->Stops()), ::TYPES[67/*Uno.Collections.ICollection<Fuse.Drawing.GradientStop>*/]), ::g::Fuse::Drawing::GradientStop::New3(::g::Uno::Float4__New8((ind2 = ::g::Uno::Color::FromHex(::STRINGS[49/*"#222"*/]), ::g::Uno::Float3__New2(ind2.X, ind2.Y, ind2.Z)), 0.9f), 0.0f));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(linearGradient->Stops()), ::TYPES[67/*Uno.Collections.ICollection<Fuse.Drawing.GradientStop>*/]), ::g::Fuse::Drawing::GradientStop::New3(::g::Uno::Float4__New8((ind3 = ::g::Uno::Color::FromHex(::STRINGS[49/*"#222"*/]), ::g::Uno::Float3__New2(ind3.X, ind3.Y, ind3.Z)), 0.9f), 1.0f));
...
// private double get_AnimationParameter() [instance] :2033
...
// public bool IsExpired() [instance] :2026
...
// private void OnUpdate() [instance] :2021
...
// public Flasher New(string text) [static] :1989
...
// internal static class GoOffline :720
// {
static void GoOffline_build(uType* type)
{
    ::STRINGS[51] = uString::Const("Go offline");
    ::TYPES[22] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Outracks::Simulator::Protocol::Reify_typeof());
    ::TYPES[68] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Outracks::Simulator::DialogButton_typeof());
    ::TYPES[69] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Outracks::Simulator::DialogButton_typeof());
    ::TYPES[70] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Outracks::Simulator::DialogButton_typeof());
    ::TYPES[44] = ::g::Outracks::Simulator::DialogButton_typeof()->Array();
    ::TYPES[71] = ::g::Outracks::Simulator::Protocol::MessageToClient_typeof()->Array();
    ::TYPES[72] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Outracks::Simulator::DialogButton_typeof());
}
...
// public static Outracks.Simulator.DialogButton[] PrependOption(Outracks.Simulator.DialogButton[] otherButtons) :722
void GoOffline__PrependOption_fn(uArray* otherButtons, uArray** __retval)
{
    *__retval = GoOffline::PrependOption(otherButtons);
}

// public static Outracks.Simulator.DialogButton[] PrependOption(Outracks.Simulator.DialogButton[] otherButtons) [static] :722
uArray* GoOffline::PrependOption(uArray* otherButtons)
{
    ...
    return oldReify.HasValue(::TYPES[22/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.Protocol.Reify>*/]) ? (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[68/*Uno.Collections.EnumerableExtensions.ToArray<Outracks.Simulator.DialogButton>*/], (uObject*)::g::Uno::Collections::EnumerableExtensions::Union(::TYPES[69/*Uno.Collections.EnumerableExtensions.Union<Outracks.Simulator.DialogButton>*/], (uObject*)::g::Uno::Collections::EnumerableExtensions::AsEnumerable(::TYPES[70/*Uno.Collections.EnumerableExtensions.AsEnumerable<Outracks.Simulator.DialogButton>*/], uArray::Init< ::g::Outracks::Simulator::DialogButton*>(::TYPES[44/*Outracks.Simulator.DialogButton[]*/], 1, (::g::Outracks::Simulator::DialogButton*)::g::Outracks::Simulator::DialogButton::New1(::STRINGS[51/*"Go offline"*/], ::g::Outracks::Simulator::Idle::New1((uObject*)::g::Outracks::Simulator::OfflineSimulatorClient::New1(uArray::Init< ::g::Outracks::Simulator::Protocol::MessageToClient*>(::TYPES[71/*Outracks.Simulator.Protocol.MessageToClient[]*/], 1, (::g::Outracks::Simulator::Protocol::Reify*)oldReify.Value(::TYPES[22/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.Protocol.Reify>*/]))))))), (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[72/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Outracks.Simulator.DialogButton>*/], otherButtons)))) : otherButtons;
}
// }
...
static void Idle_build(uType* type)
{
    ...
    ::STRINGS[43] = uString::Const("Try again");
    ::TYPES[73] = ::g::Uno::Diagnostics::LogHandler_typeof();
    ::TYPES[36] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    ::TYPES[13] = ::g::Fuse::DiagnosticHandler_typeof();
    ::TYPES[44] = ::g::Outracks::Simulator::DialogButton_typeof()->Array();
    type->SetFields(1);
...
void Idle__OnEnterState_fn(Idle* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ::g::Uno::Diagnostics::Debug::SetLogHandler(uDelegate::New(::TYPES[73/*Uno.Diagnostics.LogHandler*/], (void*)Idle__SendDebugLog_fn, __this));
...
{
    ::TYPES[35] = uObject_typeof()->Array();
    ::TYPES[74] = ::g::Uno::Array_typeof();
    ::TYPES[75] = ::g::Uno::Collections::IEnumerable_typeof();
    ::TYPES[76] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof();
    ::TYPES[77] = ::g::Uno::Collections::EnumerableExtensions_typeof();
    type->SetPrecalc(
        type->T(0)->Array(),
...
static void IndentString_build(uType* type)
{
    ...
    ::TYPES[78] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2, ::g::Uno::String_typeof(), ::g::Uno::String_typeof());
    ::TYPES[43] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[79] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[80] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof());
    type->Reflection.SetFunctions(1,
...
uString* IndentString::Indent(uString* str)
{
    ...
    return ::g::Outracks::Simulator::StringSplitting::Join((uObject*)::g::Uno::Collections::EnumerableExtensions::Select(::TYPES[78/*Uno.Collections.EnumerableExtensions.Select<string, string>*/], (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[43/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<string>*/], ::g::Uno::String::Split(uPtr(str), uArray::Init<int>(::TYPES[79/*char[]*/], 1, 10)))), uDelegate::New(::TYPES[80/*Uno.Func<string, string>*/], (void*)IndentString__PrefixWithTab_fn)), ::STRINGS[2/*"\n"*/]);
}
...
// public abstract interface ISimulatorClient :848
// {
...
{
    ::TYPES[81] = ::g::Outracks::Simulator::ImmutableList_typeof();
    ::TYPES[35] = uObject_typeof()->Array();
    ::TYPES[77] = ::g::Uno::Collections::EnumerableExtensions_typeof();
    ::TYPES[1] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[82] = ::g::Uno::Collections::IEnumerator1_typeof();
    type->SetPrecalc(
...
// public generated LoadingScreen() :1231
void LoadingScreen__ctor__fn(LoadingScreen* __this)
{
    __this->ctor_();
}

// public generated LoadingScreen New() :1231
void LoadingScreen__New1_fn(LoadingScreen** __retval)
{
    *__retval = LoadingScreen::New1();
}

// public static void Show(Outracks.Simulator.FakeApp app, string header, string message) :1233
...
// public generated LoadingScreen() [instance] :1231
void LoadingScreen::ctor_()
{
}

// public generated LoadingScreen New() [static] :1231
...
// public static void Show(Outracks.Simulator.FakeApp app, string header, string message) [static] :1233
...
// internal sealed class ModalDialog :1262
// {
static void ModalDialog_build(uType* type)
{
    ::STRINGS[55] = uString::Const("1*,auto");
    ::STRINGS[56] = uString::Const("1*,1*,2*");
    ::TYPES[11] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[83] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Controls::Control_typeof());
    ::TYPES[84] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Controls::Control_typeof());
    ::TYPES[1] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[85] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Controls::Control_typeof());
}
...
// public generated ModalDialog() :1262
void ModalDialog__ctor__fn(ModalDialog* __this)
{
    __this->ctor_();
}

// public generated ModalDialog New() :1262
void ModalDialog__New1_fn(ModalDialog** __retval)
{
    *__retval = ModalDialog::New1();
}

// public static void Show(Outracks.Simulator.FakeApp app, string header, string body, string details, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) :1308
...
// public static void ShowPrompt(Outracks.Simulator.FakeApp app, string header, string body, Fuse.Controls.Control inputControl, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) :1264
...
// public generated ModalDialog() [instance] :1262
void ModalDialog::ctor_()
{
}

// public generated ModalDialog New() [static] :1262
...
// public static void Show(Outracks.Simulator.FakeApp app, string header, string body, string details, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) [static] :1308
void ModalDialog::Show(::g::Outracks::Simulator::FakeApp* app, uString* header, uString* body, uString* details, uObject* buttons)
{
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array9), ::TYPES[11/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection10 = ::g::Fuse::Controls::Grid::New4(), uPtr(collection10)->Rows(::STRINGS[55/*"1*,auto"*/]), ::STRINGS[55/*"1*,auto"*/], array11 = uPtr(collection10)->Children(), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array11), ::TYPES[11/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection12 = ::g::Fuse::Controls::Grid::New4(), uPtr(collection12)->Rows(::STRINGS[56/*"1*,1*,2*"*/]), ::STRINGS[56/*"1*,1*,2*"*/], ind34 = ::g::Uno::Float4__New1(40.0f), uPtr(collection12)->Margin(ind34), ind34, array13 = uPtr(collection12)->Children(), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array13), ::TYPES[11/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection14 = ::g::Fuse::Controls::Image::New3(), ind35 = ::g::Uno::UX::BundleFileSource::New1(::g::OutracksSimulatorClientUno_bundle::fight469cc50d()), uPtr(collection14)->File(ind35), ind35, collection14)), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array13), ::TYPES[11/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection15 = ::g::Fuse::Controls::Text::New3(), uPtr(collection15)->Value(header), header, uPtr(collection15)->FontSize(25.0f), 25.0f, uPtr(collection15)->TextAlignment(1), 1, uPtr(collection15)->Alignment(8), 8, uPtr(collection15)->TextWrapping(1), 1, collection15)), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array13), ::TYPES[11/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection16 = ::g::Fuse::Controls::Panel::New3(), array17 = uPtr(collection16)->Children(), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array17), ::TYPES[11/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection18 = ::g::Fuse::Controls::ScrollView::New4(), ind36 = ::g::Uno::Float4__New2(0.0f, 10.0f, 0.0f, 10.0f), uPtr(collection18)->Margin(ind36), ind36, ind37 = (collection19 = ::g::Fuse::Controls::StackPanel::New4(), array20 = uPtr(collection19)->Children(), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array20), ::TYPES[11/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection21 = ::g::Fuse::Controls::Text::New3(), uPtr(collection21)->TextWrapping(1), 1, uPtr(collection21)->TextAlignment(0), 0, uPtr(collection21)->Alignment(2), 2, uPtr(collection21)->Value(body), body, uPtr(collection21)->FontSize(15.0f), 15.0f, ind38 = ::g::Uno::Float4__New2(0.0f, 0.0f, 0.0f, 20.0f), uPtr(collection21)->Margin(ind38), ind38, collection21)), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array20), ::TYPES[11/*Uno.Collections.ICollection<Fuse.Node>*/]), detailPanel), collection19), uPtr(collection18)->Content(ind37), ind37, collection18)), collection16)), collection12)), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array11), ::TYPES[11/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection22 = ::g::Fuse::Controls::Panel::New3(), array23 = uPtr(collection22)->Children(), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array23), ::TYPES[11/*Uno.Collections.ICollection<Fuse.Node>*/]), buttonGrid), collection22)), collection10));
    ...
    uArray* buttonArray = (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[83/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Controls.Control>*/], buttons);
...
// public static void ShowPrompt(Outracks.Simulator.FakeApp app, string header, string body, Fuse.Controls.Control inputControl, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) [static] :1264
void ModalDialog::ShowPrompt(::g::Outracks::Simulator::FakeApp* app, uString* header, uString* body, ::g::Fuse::Controls::Control* inputControl, uObject* buttons)
{
    ...
    for (uObject* enum6 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(buttons), ::TYPES[84/*Uno.Collections.IEnumerable<Fuse.Controls.Control>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum6), ::TYPES[1/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Controls::Control* btn = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum6), ::TYPES[85/*Uno.Collections.IEnumerator<Fuse.Controls.Control>*/]), &ret43), ret43);
...
// public sealed class OfflineSimulatorClient :857
// {
static void OfflineSimulatorClient_build(uType* type)
{
    ::TYPES[86] = ::g::Outracks::Simulator::ConcurrentQueue_typeof()->MakeType(::g::Outracks::Simulator::Protocol::MessageFromClient_typeof());
    ::TYPES[87] = ::g::Outracks::Simulator::ConcurrentQueue_typeof()->MakeType(::g::Outracks::Simulator::Protocol::MessageToClient_typeof());
    type->SetInterfaces(
...
// public OfflineSimulatorClient(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) :862
void OfflineSimulatorClient__ctor__fn(OfflineSimulatorClient* __this, uArray* initialMessages)
{
    __this->ctor_(initialMessages);
}

// public void Dispose() :878
void OfflineSimulatorClient__Dispose_fn(OfflineSimulatorClient* __this)
{
    __this->Dispose();
}

// public Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient> get_IncommingMessages() :870
...
// public bool get_IsOnline() :885
void OfflineSimulatorClient__get_IsOnline_fn(OfflineSimulatorClient* __this, bool* __retval)
{
    *__retval = __this->IsOnline();
}

// public OfflineSimulatorClient New(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) :862
...
// public void Send(Outracks.Simulator.Protocol.MessageFromClient message) :873
...
// public OfflineSimulatorClient(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) [instance] :862
void OfflineSimulatorClient::ctor_(uArray* initialMessages)
{
    ...
    int index2;
    int length3;
    _messagesFromClient = ((::g::Outracks::Simulator::ConcurrentQueue*)::g::Outracks::Simulator::ConcurrentQueue::New1(::TYPES[86/*Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageFromClient>*/]));
    _messagesToClient = ((::g::Outracks::Simulator::ConcurrentQueue*)::g::Outracks::Simulator::ConcurrentQueue::New1(::TYPES[87/*Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient>*/]));
...
// public void Dispose() [instance] :878
void OfflineSimulatorClient::Dispose()
{
}

// public Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient> get_IncommingMessages() [instance] :870
...
// public bool get_IsOnline() [instance] :885
...
// public void Send(Outracks.Simulator.Protocol.MessageFromClient message) [instance] :873
...
// public OfflineSimulatorClient New(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) [static] :862
...
{
    ::TYPES[88] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Outracks::Simulator::Task_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof()->Array()));
    ::TYPES[46] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof());
    ::TYPES[1] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[47] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof());
    ::TYPES[89] = ::g::Outracks::Simulator::Tasks_typeof()->MakeMethod(1, ::g::Uno::Net::IPEndPoint_typeof()->Array());
    ::TYPES[90] = ::g::Uno::Func_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof()->Array());
    ::TYPES[91] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[92] = ::g::Outracks::Simulator::Tasks_typeof()->MakeMethod(1, ::g::Uno::Net::IPEndPoint_typeof()->Array());
    ::TYPES[93] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Exception_typeof()), ::g::Uno::Net::IPEndPoint_typeof()->Array());
    type->Reflection.SetFunctions(2,
...
::g::Outracks::Simulator::Task* ProxyClient::GetSimulatorEndpoint(uObject* proxyEndpoints, uString* project, uObject* defines)
{
    ...
    ::g::Uno::Collections::List* tasks = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[88/*Uno.Collections.List<Outracks.Simulator.Task<Uno.Net.IPEndPoint[]>>*/]);
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(proxyEndpoints), ::TYPES[46/*Uno.Collections.IEnumerable<Uno.Net.IPEndPoint>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[1/*Uno.Collections.IEnumerator*/])); )
    {
        ...
        ::g::Uno::Collections::List__Add_fn(uPtr(tasks), (::g::Outracks::Simulator::Task*)::g::Outracks::Simulator::Tasks::Run(::TYPES[89/*Outracks.Simulator.Tasks.Run<Uno.Net.IPEndPoint[]>*/], uDelegate::New(::TYPES[90/*Uno.Func<Uno.Net.IPEndPoint[]>*/], (void*)::g::Outracks::Simulator::GetSimulatorEndpoint__Execute_fn, ::g::Outracks::Simulator::GetSimulatorEndpoint::New1(endpoint, project, (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[91/*Uno.Collections.EnumerableExtensions.ToArray<string>*/], defines)))));
    }

    return (::g::Outracks::Simulator::Task*)::g::Outracks::Simulator::Tasks::WaitForFirstResult(::TYPES[92/*Outracks.Simulator.Tasks.WaitForFirstResult<Uno.Net.IPEndPoint[]>*/], (uObject*)tasks, uDelegate::New(::TYPES[93/*Uno.Func<Uno.Collections.IEnumerable<Uno.Exception>, Uno.Net.IPEndPoint[]>*/], (void*)ProxyClient__OnNoResult_fn));
}
...
{
    ::STRINGS[0] = uString::Const("");
    ::STRINGS[57] = uString::Const("Restart");
    ::STRINGS[20] = uString::Const("N/A");
    ::STRINGS[58] = uString::Const("Density changed, reifying");
    ::STRINGS[4] = uString::Const("C:\\Users\\rashad\\AppData\\Local\\Fusetools\\Fuse\\App\\app-0.27.1.7935\\Packages\\Outracks.Simulator.Client.Uno\\0.1.0\\$.uno");
    ::TYPES[36] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    ::TYPES[44] = ::g::Outracks::Simulator::DialogButton_typeof()->Array();
    ::TYPES[94] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Visual_typeof());
    ::TYPES[95] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Visual_typeof());
    type->SetFields(1,
...
void Running__OnFaulted_fn(Running* __this, ::g::Uno::Exception* e, ::g::Outracks::Simulator::State** __retval)
{
    ...
    return *__retval = ::g::Outracks::Simulator::Faulted::New2(::g::Outracks::Simulator::ISimulatorClient::IsOnline(uInterface(uPtr(__this->Client), ::TYPES[36/*Outracks.Simulator.ISimulatorClient*/])), e, uArray::Init< ::g::Outracks::Simulator::DialogButton*>(::TYPES[44/*Outracks.Simulator.DialogButton[]*/], 1, (::g::Outracks::Simulator::DialogButton*)::g::Outracks::Simulator::DialogButton::New1(::STRINGS[57/*"Restart"*/], ::g::Outracks::Simulator::ConnectingToProxy::New1()))), void();
}
...
void Running__OnPointerPressed_fn(Running* __this, ::g::Fuse::Input::PointerPressedArgs* args, ::g::Outracks::Simulator::State** __retval)
{
    ...
    uString* selectedTag = (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(nodes), ::TYPES[94/*Uno.Collections.ICollection<Fuse.Visual>*/])) >= 1) ? (uString*)Running::GetTag((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(nodes), ::TYPES[95/*Uno.Collections.IList<Fuse.Visual>*/]), uCRef<int>(0), &ret2), ret2)) : ::STRINGS[20/*"N/A"*/];
...
void Running__OnUpdate_fn(Running* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[58/*"Density cha...*/], 1, ::STRINGS[4/*"C:\\Users\\...*/], 562);
...
{
    Serialization::ReadString_ = uDelegate::New(::TYPES[96/*Uno.Func<Uno.IO.BinaryReader, string>*/], (void*)Serialization___ReadString_fn);
}

static void Serialization_build(uType* type)
{
    ::TYPES[96] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), ::g::Uno::String_typeof());
    type->SetFields(0,
...
{
    ::STRINGS[4] = uString::Const("C:\\Users\\rashad\\AppData\\Local\\Fusetools\\Fuse\\App\\app-0.27.1.7935\\Packages\\Outracks.Simulator.Client.Uno\\0.1.0\\$.uno");
    ::TYPES[97] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Outracks::Simulator::DialogButton_typeof());
    ::TYPES[98] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Controls::Control_typeof());
    ::TYPES[99] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(1, ::g::Outracks::Simulator::DialogButton_typeof());
    ::TYPES[100] = ::g::Uno::Action1_typeof()->MakeType(::g::Outracks::Simulator::DialogButton_typeof());
    ::TYPES[53] = ::g::Fuse::Gestures::ClickedHandler_typeof();
    ::TYPES[101] = ::g::Outracks::Simulator::ForgetAction_typeof()->MakeType(uObject_typeof(), ::g::Fuse::Gestures::ClickedArgs_typeof());
    ::TYPES[102] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Outracks::Simulator::DialogButton_typeof());
    type->SetFields(0,
...
void ShowingModalDialog__OnEnterState_fn(ShowingModalDialog* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    uDelegate* ret8;
    ::g::Uno::Collections::List* buttons = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[98/*Uno.Collections.List<Fuse.Controls.Control>*/]);
    ...
    for (array1 = __this->_buttons, index2 = 0, length3 = uPtr(array1)->Length(); index2 < length3; ++index2)
    {
        ...
        uDelegate* action = (::g::Outracks::Simulator::Closure__Apply_fn(::TYPES[99/*Outracks.Simulator.Closure.Apply<Outracks.Simulator.DialogButton>*/], uDelegate::New(::TYPES[100/*Uno.Action<Outracks.Simulator.DialogButton>*/], (void*)ShowingModalDialog__OnButtonClicked_fn, __this), button, &ret8), ret8);
        uDelegate* handler = uDelegate::New(::TYPES[53/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Outracks::Simulator::ForgetAction__Execute_fn, (::g::Outracks::Simulator::ForgetAction*)::g::Outracks::Simulator::ForgetAction::New1(::TYPES[101/*Outracks.Simulator.ForgetAction<object, Fuse.Gestures.ClickedArgs>*/], action));
...
void ShowingModalDialog__OnException_fn(ShowingModalDialog* __this, ::g::Uno::Exception* e, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->Message(), 1, ::STRINGS[4/*"C:\\Users\\...*/], 1540);
    return *__retval = __this, void();
}
...
void ShowingModalDialog__OnUpdate_fn(ShowingModalDialog* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    if (__this->_clickedButton().Value< ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::DialogButton*> > >().HasValue(::TYPES[102/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.DialogButton>*/]))
        return *__retval = uPtr(__this->_clickedButton().Value< ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::DialogButton*> > >().Value(::TYPES[102/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.DialogButton>*/]))->Destination, void();
...
void ShowingModalDialog::OnButtonClicked(::g::Outracks::Simulator::DialogButton* button)
{
    ...
    _clickedButton().Value< ::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::DialogButton*> > >() = (::g::Outracks::Simulator::Bytecode::Optional__Some_fn(::TYPES[97/*Outracks.Simulator.Bytecode.Optional.Some<Outracks.Simulator.DialogButton>*/], button, &ret7), ret7);
}
...
{
    ::STRINGS[59] = uString::Const("Ok");
    ::STRINGS[60] = uString::Const("Cancel");
    ::STRINGS[61] = uString::Const("# ");
    ::STRINGS[4] = uString::Const("C:\\Users\\rashad\\AppData\\Local\\Fusetools\\Fuse\\App\\app-0.27.1.7935\\Packages\\Outracks.Simulator.Client.Uno\\0.1.0\\$.uno");
    ::TYPES[53] = ::g::Fuse::Gestures::ClickedHandler_typeof();
    ::TYPES[103] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Fuse::Controls::Control_typeof());
    ::TYPES[104] = ::g::Fuse::Controls::Control_typeof()->Array();
    type->SetFields(0,
...
void ShowingPrompt__OnEnterState_fn(ShowingPrompt* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ;
    uPtr(collection1)->Text(::STRINGS[59/*"Ok"*/]);
    ::STRINGS[59/*"Ok"*/];
    ...
    ;
    uPtr(collection2)->Text(::STRINGS[60/*"Cancel"*/]);
    ::STRINGS[60/*"Cancel"*/];
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[61/*"# "*/], __this->_header), 1, ::STRINGS[4/*"C:\\Users\\...*/], 1450);
    ::g::Uno::Diagnostics::Debug::Log5(__this->_body, 1, ::STRINGS[4/*"C:\\Users\\...*/], 1451);
    ::g::Outracks::Simulator::ModalDialog::ShowPrompt(::g::Outracks::Simulator::Context::App(), __this->_header, __this->_body, __this->_input, (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[103/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Fuse.Controls.Control>*/], uArray::Init< ::g::Fuse::Controls::Control*>(::TYPES[104/*Fuse.Controls.Control[]*/], 2, cancel, ok))));
    return *__retval = __this, void();
}
...
// public sealed class SimulatorClient :946
// {
...
// public void Dispose() [instance] :1031
void SimulatorClient::Dispose()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->Message(), 1, ::STRINGS[4/*"C:\\Users\\...*/], 1046);
    }
}

// public Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient> get_IncommingMessages() [instance] :959
...
// public bool get_IsOnline() [instance] :1052
...
// private void ReadLoop() [instance] :993
...
// public void Send(Outracks.Simulator.Protocol.MessageFromClient message) [instance] :962
...
// private void WriteLoop() [instance] :1011
...
// public SimulatorClient New(Uno.Net.Sockets.Socket socket) [static] :967
...
{
    ::TYPES[105] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[1] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[106] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[75] = ::g::Uno::Collections::IEnumerable_typeof();
    ::TYPES[82] = ::g::Uno::Collections::IEnumerator1_typeof();
    type->SetPrecalc(
...
// internal sealed class UserAppState :756
// {
static void UserAppState_build(uType* type)
{
    ::TYPES[111] = UserAppState_typeof()->MakeMethod(1, ::g::Fuse::Node_typeof());
    ::TYPES[112] = UserAppState_typeof()->MakeMethod(1, ::g::Uno::UX::Resource_typeof());
    ::TYPES[113] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Node_typeof());
    ::TYPES[114] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Uno::UX::Resource_typeof());
...
// public UserAppState(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor, float clearDepth) :770
...
// public static generated Outracks.Simulator.UserAppState get_Default() :785
void UserAppState__get_Default_fn(UserAppState** __retval)
{
    *__retval = UserAppState::Default();
}

// public static generated void set_Default(Outracks.Simulator.UserAppState value) :785
void UserAppState__set_Default_fn(UserAppState* value)
{
    UserAppState::Default(value);
}

// public UserAppState New(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor, float clearDepth) :770
...
// public static Outracks.Simulator.UserAppState Save(Outracks.Simulator.FakeApp app) :787
void UserAppState__Save_fn(::g::Outracks::Simulator::FakeApp* app, UserAppState** __retval)
{
    *__retval = UserAppState::Save(app);
}

// private static bool SequenceEquals<T>(Uno.Collections.IList<T> left, T[] right) :818
...
// private static void SetIfNotEqual<T>(Uno.Collections.IList<T> list, T[] elements) :806
...
// private static void SetSequence<T>(Uno.Collections.IList<T> list, T[] elements) :812
...
// public UserAppState(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor, float clearDepth) [instance] :770
...
// public UserAppState New(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor, float clearDepth) [static] :770
...
// public static Outracks.Simulator.UserAppState Save(Outracks.Simulator.FakeApp app) [static] :787
UserAppState* UserAppState::Save(::g::Outracks::Simulator::FakeApp* app)
{
    ...
    return UserAppState::New1(uPtr(app)->Background1(), (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[113/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Node>*/], uPtr(app)->Children1()), (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[114/*Uno.Collections.EnumerableExtensions.ToArray<Uno.UX.Resource>*/], uPtr(app)->Resources1()), uPtr(app)->ClearColor(), uPtr(app)->ClearDepth());
}

// private static bool SequenceEquals<T>(Uno.Collections.IList<T> left, T[] right) [static] :818
...
// private static void SetIfNotEqual<T>(Uno.Collections.IList<T> list, T[] elements) [static] :806
...
// private static void SetSequence<T>(Uno.Collections.IList<T> list, T[] elements) [static] :812
...
// public static generated Outracks.Simulator.UserAppState get_Default() [static] :785
...
// public static generated void set_Default(Outracks.Simulator.UserAppState value) [static] :785
