...
// C:\Users\rashad\AppData\Local\Fusetools\Fuse\App\app-0.27.1.7935\Packages\UnoCore\0.38.2\source\uno\collections\$.uno
// ---------------------------------------------------------------------------------------------------------------------
...
// C:\Users\rashad\AppData\Local\Fusetools\Fuse\App\app-0.27.1.7935\Packages\Uno.Collections\0.38.0\extensions\$.uno
// -----------------------------------------------------------------------------------------------------------------
...
static void EnumerableExtensions_build(uType* type)
{
    ...
    ::TYPES[15] = EnumerableExtensions__LinkedList_typeof();
    ::TYPES[0] = uObject_typeof()->Array();
    ::TYPES[16] = ::g::Uno::Collections::List_typeof();
    ::TYPES[17] = ::g::Uno::Collections::UnionEnumerable_typeof();
    ::TYPES[18] = ::g::Uno::Collections::WhereEnumerable_typeof();
    type->SetPrecalc(
...
{
    uType* __types[] = {
        __type->Precalced(10/*Uno.Collections.OfTypeEnumerable<T, U>*/),
    };
...
{
    uType* __types[] = {
        __type->Precalced(11/*Uno.Collections.EnumerableExtensions.ToList<T>*/),
        __type->Precalced(12/*Uno.Comparison<T>*/),
        __type->Precalced(13/*Uno.Collections.OrderByCompare<T>*/),
    };
...
{
    uType* __types[] = {
        __type->Precalced(14/*Uno.Collections.SelectEnumerable<T, TRet>*/),
    };
...
::g::Uno::Collections::List* EnumerableExtensions::ToList(uType* __type, uObject* self)
{
    uType* __types[] = {
        ...
        __type->Precalced(22/*Uno.Collections.List<T>*/),
        __type->Precalced(23/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<T>*/),
        __type->Precalced(24/*T[]*/),
    };
...
{
    uType* __types[] = {
        __type->Precalced(25/*Uno.Collections.UnionEnumerable<T>*/),
    };
...
{
    uType* __types[] = {
        __type->Precalced(26/*Uno.Collections.WhereEnumerable<T>*/),
    };
...
// C:\Users\rashad\AppData\Local\Fusetools\Fuse\App\app-0.27.1.7935\Packages\Uno.Collections\0.38.0\$.uno
// ------------------------------------------------------------------------------------------------------
...
// C:\Users\rashad\AppData\Local\Fusetools\Fuse\App\app-0.27.1.7935\Packages\FuseCore\0.38.6\internal\$.uno
// --------------------------------------------------------------------------------------------------------

// internal sealed class PriorityQueue<T> :614
// {
...
// public PriorityQueue([Uno.Collections.PriorityQueueType type]) :619
void PriorityQueue__ctor__fn(PriorityQueue* __this, int* type)
{
    __this->ctor_(*type);
}

// public void Add(T value, [float priority]) :648
...
// public void Remove(T value) :654
...
// public int get_Count() [instance] :681
...
// public bool get_Empty() [instance] :676
...
// private int LowerBound(float priority) [instance] :627
...
// private int UpperBound(float priority) [instance] :639
...
// public PriorityQueue New([Uno.Collections.PriorityQueueType type]) [static] :619
...
// internal enum PriorityQueueType :602
...
{
    ::TYPES[36] = ::g::Uno::Collections::WhereEnumerator_typeof();
    ::TYPES[2] = ::g::Uno::Collections::IEnumerable_typeof();
    type->SetPrecalc(
