...
// public generated Dns() :993
void Dns__ctor__fn(Dns* __this)
{
    __this->ctor_();
}

// public static Uno.Net.IPAddress[] GetHostAddresses(string hostNameOrAddress) :1106
void Dns__GetHostAddresses_fn(uString* hostNameOrAddress, uArray** __retval)
{
    *__retval = Dns::GetHostAddresses(hostNameOrAddress);
}

// private static Uno.Net.IPAddress[] GetHostAddressesImpl(string hostNameOrAddress) :1076
...
// private static extern Uno.Net.IPAddress[] GetLocalAddresses() :1063
void Dns__GetLocalAddresses_fn(uArray** __retval)
{
    *__retval = Dns::GetLocalAddresses();
}

// private static extern bool JavaGetLocalAddresses(Uno.Collections.List<string> addresses) :1027
...
// public generated Dns New() :993
void Dns__New1_fn(Dns** __retval)
{
    *__retval = Dns::New1();
}

// public generated Dns() [instance] :993
void Dns::ctor_()
{
}

// public static Uno.Net.IPAddress[] GetHostAddresses(string hostNameOrAddress) [static] :1106
...
// private static Uno.Net.IPAddress[] GetHostAddressesImpl(string hostNameOrAddress) [static] :1076
...
// private static extern Uno.Net.IPAddress[] GetLocalAddresses() [static] :1063
...
// private static extern bool JavaGetLocalAddresses(Uno.Collections.List<string> addresses) [static] :1027
bool Dns::JavaGetLocalAddresses(::g::Uno::Collections::List* addresses)
{
    uStackFrame __("Uno.Net.Dns", "JavaGetLocalAddresses(Uno.Collections.List<string>)");
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "JavaGetLocalAddresses50", "(Ljava/lang/Object;)Z");
...
// public generated Dns New() [static] :993
Dns* Dns::New1()
{
