...
// C:\Users\rashad\AppData\Local\Fusetools\Fuse\App\app-0.27.1.7935\Packages\FuseJS\0.38.6\$.uno
// ---------------------------------------------------------------------------------------------
...
static void RaiseEvent_build(uType* type)
{
    ...
    ::STRINGS[39] = uString::Const("C:\\Users\\rashad\\AppData\\Local\\Fusetools\\Fuse\\App\\app-0.27.1.7935\\Packages\\FuseJS\\0.38.6\\$.uno");
...
void RaiseEvent::Raise()
{
    ...
    if (dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[38/*"Cannot find...*/], Name), this, ::STRINGS[39/*"C:\\Users\\...*/], 688, ::STRINGS[40/*"Raise"*/]);
        return;
    }
...
uObject* UserEvents::Raise(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[43/*"The FuseJS/...*/], context, ::STRINGS[39/*"C:\\Users\\...*/], 719, ::STRINGS[40/*"Raise"*/]);
