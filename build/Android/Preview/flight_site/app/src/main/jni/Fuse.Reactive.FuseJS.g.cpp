...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    uPtr(context)->Evaluate(::STRINGS[0/*"es6-promise"*/], uPtr(::g::FuseReactive_bundle::es6promiseb9e97a61())->ReadAllText());
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseReactive_bundle::Observablee7198c6d()))->EvaluateExports(context, ::STRINGS[1/*"FuseJS/Obse...*/]), ::TYPES[0/*Fuse.Scripting.Function*/]);
    uObject* res;
...
// public double GetMinTimeout() :361
...
// public double GetMinTimeout() [instance] :361
...
// public double get_MinTimeout() :228
...
// public double get_MinTimeout() [instance] :228
