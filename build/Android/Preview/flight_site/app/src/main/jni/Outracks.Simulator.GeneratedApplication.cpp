// This file was generated based on C:\Users\rashad\Documents\GitHub\Flight-Site\build\Android\Preview\preamble\$.uno.
...
static void GeneratedApplication_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("192.168.1.67");
    ::STRINGS[2] = uString::Const("C:\\Users\\rashad\\Documents\\GitHub\\Flight-Site\\flight_site.unoproj");
    ::STRINGS[3] = uString::Const("flight_site");
...
::g::Uno::IO::Bundle* GeneratedApplication::GetBundle()
{
    ...
    return ::g::Uno::IO::Bundle::Get(::STRINGS[3/*"flight_site"*/]);
}
