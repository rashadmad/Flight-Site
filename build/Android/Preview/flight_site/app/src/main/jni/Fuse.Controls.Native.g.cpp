...
// C:\Users\rashad\AppData\Local\Fusetools\Fuse\App\app-0.27.1.7935\Packages\Fuse.Controls.Native\0.38.6\$.uno
// -----------------------------------------------------------------------------------------------------------
...
::g::Java::Object* ImageLoader__ImageHandlePromise::Download1(uString* url)
{
    uStackFrame __("Fuse.Controls.Native.ImageLoader.ImageHandlePromise", "Download(string)");
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Download1191", "(Ljava/lang/String;)Ljava/lang/Object;");
        uString* _uurl=url;
...
::g::Java::Object* ImageLoader::LoadFile(uString* filePath)
{
    ...
    ImageLoader_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "LoadFile192", "(Ljava/lang/String;)Ljava/lang/Object;");
...
::g::Java::Object* ImageLoader::LoadUri(uString* uri)
{
    ...
    ImageLoader_typeof()->Init();
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "LoadUri193", "(Ljava/lang/String;)Ljava/lang/Object;");
        uString* _uuri=uri;
