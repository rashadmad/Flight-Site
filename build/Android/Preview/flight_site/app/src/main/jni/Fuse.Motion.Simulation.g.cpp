...
// C:\Users\rashad\AppData\Local\Fusetools\Fuse\App\app-0.27.1.7935\Packages\Fuse.Motion\0.38.6\simulation\$.uno
// -------------------------------------------------------------------------------------------------------------
...
static void EasingMotion_build(uType* type)
{
    ...
    ::TYPES[0] = ::g::Fuse::Internal::BlenderMap_typeof();
    ::TYPES[9] = ::g::Fuse::Animations::EasingFunction_typeof();
    type->SetPrecalc(
        ::g::Fuse::Internal::BlenderMap_typeof()->MakeMethod(1, type->T(0)));
    type->SetInterfaces(
...
void EasingMotion::ctor_()
{
    ...
    _isDirty = true;
    _isStatic = true;
    _easingFunc = uDelegate::New(::TYPES[9/*Fuse.Animations.EasingFunction*/], (void*)::g::Fuse::Animations::EasingFunctions__Linear_fn);
    _progress = 1.0;
    _progressSpeed = 0.0;
    _transitionTime = 1.0;
