...
// C:\Users\rashad\AppData\Local\Fusetools\Fuse\App\app-0.27.1.7935\Packages\Fuse.Elements\0.38.6\triggers\actions\$.uno
// ---------------------------------------------------------------------------------------------------------------------
...
// public generated EvaluateJS() :877
...
// private string PrepareScriptForEval(string js) :898
...
// public generated EvaluateJS() [instance] :877
...
// public string get_JavaScript() [instance] :893
...
// public void set_JavaScript(string value) [instance] :894
...
// private string PrepareScriptForEval(string js) [instance] :898
...
// public generated EvaluateJS New() [static] :877
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("C:\\Users\\rashad\\AppData\\Local\\Fusetools\\Fuse\\App\\app-0.27.1.7935\\Packages\\Fuse.UserEvents\\0.38.6\\$.uno");
...
// C:\Users\rashad\AppData\Local\Fusetools\Fuse\App\app-0.27.1.7935\Packages\Fuse.Controls.Navigation\0.38.6\$.uno
// ---------------------------------------------------------------------------------------------------------------
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("C:\\Users\\rashad\\AppData\\Local\\Fusetools\\Fuse\\App\\app-0.27.1.7935\\Packages\\Fuse.Controls.Navigation\\0.38.6\\$.uno");
    ::STRINGS[9] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    ::g::Fuse::Controls::Navigator* nav = (n == NULL) ? uCast< ::g::Fuse::Controls::Navigator*>(NULL, ::TYPES[20/*Fuse.Controls.Navigator*/]) : uAs< ::g::Fuse::Controls::Navigator*>(uPtr(n)->Parent(), ::TYPES[20/*Fuse.Controls.Navigator*/]);

    if ((v == NULL) || (nav == NULL))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[10/*"Requires a ...*/], __this, ::STRINGS[11/*"C:\\Users\\...*/], 283, ::STRINGS[9/*"Perform"*/]);
        return;
    }
...
static void Set_build(uType* type)
{
    ...
    ::TYPES[21] = ::g::Fuse::Internal::BlenderMap_typeof();
    type->SetPrecalc(
...
{
    ::TYPES[22] = ::g::Fuse::Triggers::Actions::IShow_typeof();
    type->SetFields(8);
    type->Reflection.SetFunctions(1,
...
void Show__Perform_fn(Show* __this, ::g::Fuse::Node* target)
{
    ...
    if (uIs(target, ::TYPES[22/*Fuse.Triggers.Actions.IShow*/]))
        ::g::Fuse::Triggers::Actions::IShow::Show(uInterface(uPtr((uObject*)target), ::TYPES[22/*Fuse.Triggers.Actions.IShow*/]));
}
...
{
    ::TYPES[23] = ::g::Fuse::Triggers::Actions::IToggleable_typeof();
    type->SetFields(8,
...
void Toggle__Perform_fn(Toggle* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
        ::g::Fuse::Triggers::Actions::IToggleable::Toggle(uInterface(uPtr(t), ::TYPES[23/*Fuse.Triggers.Actions.IToggleable*/]));
}
...
uObject* Toggle::FindTarget(::g::Fuse::Node* n)
{
    ...
    while (n != NULL)
    {
        uObject* iv = uAs<uObject*>(n, ::TYPES[23/*Fuse.Triggers.Actions.IToggleable*/]);
...
void TransitionLayout__Perform_fn(TransitionLayout* __this, ::g::Fuse::Node* target)
{
    ...
    ::g::Fuse::UpdateManager::AddDeferredAction(uDelegate::New(::TYPES[24/*Uno.Action*/], (void*)TransitionLayout__Transition_fn, __this), 1, ::g::Fuse::LayoutPriority::Placement());
}
