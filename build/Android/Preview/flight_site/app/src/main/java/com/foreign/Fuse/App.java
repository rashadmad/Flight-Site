        ...
        if (android.os.Build.VERSION.SDK_INT >= 16)
        			{
        				android.view.Choreographer.getInstance().postFrameCallback(new android.view.Choreographer.FrameCallback()
        				{
        					...
        					public void doFrame(long frameTimeNanos)
        					{
        						...
        						ExternedBlockHost.callUno_Fuse_App_OnFrameCallback274(_this,currentTime,deltaTime);
        			...
        			else
        			{
        				...
        				timeAnimator.setTimeListener(new android.animation.TimeAnimator.TimeListener()
        				{
        					...
        					{
        						ExternedBlockHost.callUno_Fuse_App_OnFrameCallback274(_this,totalTime / 1000.0,deltaTime / 1000.0);
        					}
        				});
        				timeAnimator.start();
        			}
