...
//    #endif
    {
        return com.apps.flight_site.flight_site.RootActivity();
    }

    // - - - - - - - - - - - - - - - - - - - - - - - -

    public interface LifecycleListener extends com.apps.flight_site.ActivityState.AndroidLifecycleListener {}

    public static void subscribeToLifecycleChange(LifecycleListener listener)
	{
        com.apps.flight_site.flight_site activity = (com.apps.flight_site.flight_site)getRootActivity();
