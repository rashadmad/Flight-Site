...
//#else
public class flight_site extends android.app.Activity implements ActivityCompat.OnRequestPermissionsResultCallback
//#endif
{
...
//#endif
    ...
    {
    	flight_site activity = _appState.CurrentActivity;
...
//#endif
    ...
    public static flight_site RootActivity()
    {
        return _appState.CurrentActivity;
    }
