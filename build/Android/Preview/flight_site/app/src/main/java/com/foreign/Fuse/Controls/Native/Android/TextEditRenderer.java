...
public class TextEditRenderer
{
    ...
    {
        android.widget.GridLayout gridLayout = new android.widget.GridLayout(com.apps.flight_site.flight_site.GetRootActivity());
    ...
    {
        android.widget.TextView tv = new android.widget.TextView(com.apps.flight_site.flight_site.GetRootActivity());
