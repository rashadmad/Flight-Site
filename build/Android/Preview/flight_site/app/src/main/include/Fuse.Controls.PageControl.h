...
void PageControl__add_ActivePageChanged_fn(PageControl* __this, uDelegate* value);
void PageControl__remove_ActivePageChanged_fn(PageControl* __this, uDelegate* value);
