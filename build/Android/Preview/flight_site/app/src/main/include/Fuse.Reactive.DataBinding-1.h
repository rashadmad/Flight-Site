...
struct DataBinding : ::g::Fuse::Reactive::ContextBinding
{
    ...
    void ctor_3(::g::Uno::UX::Property1* target, uString* key, bool isTwoWay);
    ...
    static DataBinding* New2(uType* __type, ::g::Uno::UX::Property1* target, uString* key, bool isTwoWay);
