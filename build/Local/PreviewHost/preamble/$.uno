...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.1.67"), 12124)}, "C:\\Users\\rashad\\Documents\\GitHub\\Flight-Site\\flight_site.unoproj", GetBundle, new string[] { ""})
{
